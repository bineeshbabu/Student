...
public class PieChartActivity extends android.support.v4.app.Fragment implements PieChartOnValueSelectListener {
    ...
    private void generateData() {
        ...
        if (hasCenterText1) {
            ...
            Typeface tf = Typeface.createFromAsset(getActivity().getAssets(), "fonts/HelveticaNeue.ttf");
